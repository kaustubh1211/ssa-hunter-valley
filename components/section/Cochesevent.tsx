    ...
    <section className="grid grid-cols-1 md:grid-cols-2 h-auto md:h-[20vw]">
      ...
      <div className="relative h-[60vw] md:h-full overflow-hidden group cursor-pointer">
        ...
        <div className="relative z-10 h-full flex flex-col justify-center">
          <div className="max-w-[90vw] md:max-w-[85vw] mx-auto w-full px-[6vw] md:px-[5vw]">
            <div className="flex items-center gap-[1vw] mb-[2vw] md:mb-[1vw]">
              <h2 className="text-[6vw] md:text-[2.3vw] font-bold text-white">Our Coaches</h2>
              <div className="w-[1vw] h-[1vw] md:w-[0.5vw] md:h-[0.5vw] bg-[#99B81B] rounded-full"></div>
            </div>

            <p className="text-[3.5vw] md:text-[0.9vw] font-light mb-[4vw] md:mb-[2vw] max-w-[80vw] md:max-w-[20vw] leading-[1.6] text-white">
              Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.
            </p>

            <button className="flex items-center gap-[2vw] md:gap-[0.8vw] text-[3.5vw] md:text-[0.9vw] font-medium group-hover:gap-[3vw] md:group-hover:gap-[1.2vw] transition-all text-white">
              Read More
      ...
      <div className="relative h-[60vw] md:h-full overflow-hidden group cursor-pointer bg-[#99B81B]">
        ...
        <div className="relative z-10 h-full flex flex-col justify-center">
          <div className="max-w-[90vw] md:max-w-[85vw] mx-auto w-full px-[6vw] md:px-[5vw]">
            <div className="flex items-center gap-[1vw] mb-[2vw] md:mb-[1vw]">
              <h2 className="text-[6vw] md:text-[2.3vw] font-bold text-white">Events</h2>
